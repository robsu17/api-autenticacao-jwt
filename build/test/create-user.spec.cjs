...
// src/test/create-user.spec.ts
var import_bcrypt2 = __toESM(require("bcrypt"), 1);
var repository;
describe("Teste de registro de usu\xE1rio", () => {
  beforeEach(() => {
    repository = new InMemoryUsersRepository();
  });
  it("Usu\xE1rio deve se cadastrar", async () => {
  ...
  it("Senha do usu\xE1rio deve ser encriptada", async () => {
    ...
    const senhaCriptada = await import_bcrypt2.default.compare(
      "123456",
      userResponse.user.senha
    );
    globalExpect(senhaCriptada).toBe(true);
  });
  it("Usu\xE1rio n\xE3o deve se cadastrar com e-mail j\xE1 cadastrado", async () => {

...
// src/test/authenticate-user.spec.ts
var repository;
describe("Teste de autentica\xE7\xE3o de usu\xE1rio", () => {
  beforeEach(() => {
    repository = new InMemoryUsersRepository();
  });
  it("Usu\xE1rio deve logar com cred\xEAnciais corretas", async () => {
    ...
    globalExpect(userResponse.user.email).toEqual(email);
  });
  it("Usu\xE1rio n\xE3o deve logar com cred\xEAnciais inv\xE1lidas", async () => {
    await repository.create({
      nome: "John Doe",
  ...
  it("Usu\xE1rio ao logar deve ser gerado o token JWT", async () => {
    const email = "johndoe@gmail.com";
    const senha = "123456";
    await repository.create({
      nome: "John Doe",
    ...
    globalExpect(user.token).toEqual(globalExpect.any(String));
  });
  it("Ao logar deve se cadastrar deve ser gerado um token JWT", async () => {
    ...
    globalExpect(userCreated.token).toEqual(globalExpect.any(String));
  });
});
